...
#ifndef PB_NONNA_PROTO_SRC_PROTO_NONNA_PB_H_INCLUDED
#define PB_NONNA_PROTO_SRC_PROTO_NONNA_PB_H_INCLUDED
#include <pb.h>
...
#define NONNA_PROTO_SRC_PROTO_NONNA_PB_H_MAX_SIZE nonna_proto_NonnaMsg_size
